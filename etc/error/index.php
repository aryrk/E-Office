...
if(isset($_POST['HOME'])){
	header("Location: ../../unused.php?value=logout");
}
if(isset($_POST['HELP'])){
...
if ($condition == 1){
	echo
        '<h1>404</h1>
        <h2>UH OH! Kamu tersesat.</h2>
        <p>Tampaknya kamu berada di URL yang salah, tekan tombol dibawah untuk menuju laman Officia.
        </p>
		 <form id="form1" name="form1" method="post" action="">
        <button class="btn green" type="submit" name="HOME" id="HOME" value="Home">HOME</button>
		  </form>';
}
